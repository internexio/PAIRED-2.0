...
# Usage: source .windsurf/scripts/set-env.sh [dev|test|prod]
...
# Get project root (parent of .windsurf directory)
...
case "$ENV_TYPE" in
    ...
    *)
        ...
        echo "Usage: source .windsurf/scripts/set-env.sh [dev|test|prod]"
        return 1
        ;;
esac
